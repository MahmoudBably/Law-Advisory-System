    ...
    <nav class="n-color navbar navbar-toggleable-md navbar-fixed-top navbar-light bg-faded">
              ...
              <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item title-2"><a class="nav-link title" href="?page=controllers/C_addCase">MY CASES</a></li>
                    <li class="nav-item title-2"><a class="nav-link title" href="?page=controllers/C_appointments">APPOINTMENTS</a></li>
