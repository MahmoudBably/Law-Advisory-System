...
<html>
    <head>
        ...
        <link rel="icon" href="Bikes/Logo3.png">
        
        <script type="text/javascript" src="yjquery-3.1.0.js"></script>
        ...
        <div class="container-fluid">
            ...
            <section class="container con-color">
                <br /><div class="heading col-md-12">
                    <h3 style="text-align:left;">EDIT SCHEDULE</h3><hr />
                </div><br /><br />
                ...
                <div class="col-sm-6 ">
                    <h3 class="heading head" style="text-align:left;">EDIT SCHEDULE</h3><hr />
                    <div class="modal-body case-form">
                        <label>Time Of Meeting</label>
                        <form action="" method="post" class="message">
                        <input class="input-style form-control" required="required" type="datetime-local" name="time" value="2017-05-15T00:00:00" />
                        <br></br>
                        <button value="Edit" class="btn btn-success">EDIT</button><br /><br />
                        </form>
                    </div>
                </div>
            </section>
